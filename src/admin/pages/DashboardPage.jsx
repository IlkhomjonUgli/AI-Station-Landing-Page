    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.header}>
                <div>
                    <h1 style={styles.title}>Posts Management</h1>
                    <p style={styles.subtitle}>Manage your blog posts and news articles</p>
                </div>
                <button onClick={() => navigate('/admin/posts/new')} style={styles.createBtn}>
                    + Create New Post
                </button>
            </div>
